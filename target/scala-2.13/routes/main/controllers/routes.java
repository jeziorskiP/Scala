...
public class routes {
  ...
  public static final controllers.ReverseBorrowerController BorrowerController = new controllers.ReverseBorrowerController(RoutesPrefix.byNamePrefix());
  ...
  public static final controllers.ReverseBookItemController BookItemController = new controllers.ReverseBookItemController(RoutesPrefix.byNamePrefix());
  public static final controllers.ReverseBorrowerBookItemController BorrowerBookItemController = new controllers.ReverseBorrowerBookItemController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseBorrowerController BorrowerController = new controllers.javascript.ReverseBorrowerController(RoutesPrefix.byNamePrefix());
    ...
    public static final controllers.javascript.ReverseBookItemController BookItemController = new controllers.javascript.ReverseBookItemController(RoutesPrefix.byNamePrefix());
    public static final controllers.javascript.ReverseBorrowerBookItemController BorrowerBookItemController = new controllers.javascript.ReverseBorrowerBookItemController(RoutesPrefix.byNamePrefix());
  }
